...
public class IndexController {
    ...
    public  String profile(@PathVariable("groupId") String groupId,
                           ...
                           @RequestParam(value = "type", defaultValue = "l") int type,
    ...
    @ResponseBody
    public String response(@CookieValue(value = "noecoderid", defaultValue = "a") String nowcoder,
